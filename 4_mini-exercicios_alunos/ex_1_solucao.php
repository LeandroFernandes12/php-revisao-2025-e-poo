...
abstract class ItemBiblioteca{
    ...
    // Inicialização com o método Construtor 
...
// Testando devolução
echo $biblioteca->devolverItem("TechNews") . "<br><br>";

// Calcular multa de atraso
echo "Multa da revista (5 dias): R$" . number_format($revista1->calcularMulta(5), 2) . "<br>";
echo "Multa do livro (5 dias): R$" . number_format($livro1->calcularMulta(5), 2) . "<br><br>";
